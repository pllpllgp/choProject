	...
	<form id="userInfo" method="post">
		...
		<table class="mm-search">
			<tr>
				...
				<th class="text-muted" style="width:80px; text-align: right;">부서명</th>
				...
				<th class="text-muted" style="width:100px; text-align: right;">완료 여부</th>
				<td style="width:120px;">
							...
							<td>
								<table class="table table-bordered">	
									...
									<tr>
										...
										<td id="adminTeamYN" name="adminTeamYN">${item.v_disable }</td>
										<td>${item.d_job_date }</td>
										<td>${item.v_dept_code }</td>
										<td>${item.v_dept_code_name }</td>
										<td>${item.v_dept_name }</td>
										<td>${item.v_man_seq }</td>
										<td>${item.v_user_name_k }</td>
										<td>${item.d_enter_date }</td>
										<td>${item.d_retirement_date }</td>
										<td>${item.i_day_count }</td>
										<td id="userMM" name="userMM">${item.d_mm }</td>
									</tr>
								</table>
							</td>
						</c:if>
